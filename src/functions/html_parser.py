...
STATIC_FIELDS_HTML = "../data/html/lseg_static_fields.html"
TIME_SERIES_FIELDS_HTML = "../data/html/lseg_time_series_fields.html"
STATIC_OUTPUT = "../data/parameter/tr_values_static.txt"
TIME_SERIES_OUTPUT = "../data/parameter/tr_values_time_series.txt"


def parse(html_path, output):
